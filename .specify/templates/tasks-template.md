...
**Automated tests**: **FORBIDDEN** by `.specify/memory/constitution.md` (Principle V). Do not include unit, integration, E2E, or test-runner tasks. Remove any sample test tasks when generating `tasks.md`.
...
<!-- 
  ...
  - Manually verified / demonstrated independently
...
**Manual verification**: [How to verify this story works on its own without automated tests]
...
**Checkpoint**: At this point, User Story 1 should be fully functional and independently demonstrable
